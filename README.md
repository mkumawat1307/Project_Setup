...
18. creat requirements.txt for installing packages
19. creat file 'init_setup.sh' in current folder and put below commands init_setup.sh file
	echo [$(date)]: "START"
	...
	echo [$(date)]: "END"
20. init_setup.sh file only works in git bash command prompt for run init_setup.sh file command is "bash init_setup.sh"
